...
//		// io.KeyDown[] array that we will update during the application
//		// lifetime.
...
//
//template<>
//ImguiManager* Singleton<ImguiManager>::msSingleton = 0;
//
//
...
//}
//
//ImguiManager::ImguiManager() : mSceneMgr(0) { ImGui::CreateContext(); }
...
//	            "re-build with OgreBites component");
//	return NULL;
//#endif
//}
//
...
//	// (important for DirectX9) See also:
//	//     - OGRE-API specific hint:
//	//     http://www.ogre3d.org/forums/viewtopic.php?f=5&p=536881#p536881
...
//
//	mRenderable.mXform =
//	    Matrix4(2.0f / (R - L), 0.0f, 0.0f, (L + R) / (L - R), 0.0f,
//	            -2.0f / (B - T), 0.0f, (T + B) / (B - T), 0.0f, 0.0f, -1.0f,
...
//		mRenderable.updateVertexData(draw_list->VtxBuffer,
//		                             draw_list->IdxBuffer);
//
...
//			// Set scissoring
//			int scLeft =
//			    static_cast<int>(drawCmd->ClipRect.x);  // Obtain bounds
...
//			scBottom =
//			    scBottom < 0 ? 0 : (scBottom > vpHeight ? vpHeight : scBottom);
//
//			if(mRenderable.mMaterial->getSupportedTechniques().empty()) {
//				mRenderable.mMaterial
//				    ->load();  // Support for adding lights run time
//			}
...
//				    (Ogre::ResourceHandle) drawCmd->TextureId;
...
//			mSceneMgr->_injectRenderWithPass(pass, &mRenderable, false);
//
//			// Update counts
...
//	    ResourceGroupManager::getSingleton().openResource(font->getSource(),
//	                                                      font->getGroup());
...
//	    "ImguiFontTex",
//	    Ogre::ResourceGroupManager::INTERNAL_RESOURCE_GROUP_NAME, TEX_TYPE_2D,
...
//	io.DisplaySize = ImVec2((float) (windowRect.right - windowRect.left),
...
//}
////-----------------------------------------------------------------------------------
//void ImguiManager::ImGUIRenderable::updateVertexData(
//    const ImVector<ImDrawVert>& vtxBuf, const ImVector<ImDrawIdx>& idxBuf) {
//	Ogre::VertexBufferBinding* bind = mRenderOp.vertexData->vertexBufferBinding;
//
//	if(bind->getBindings().empty() ||
//	   bind->getBuffer(0)->getNumVertices() != vtxBuf.size()) {
//		bind->setBinding(
//		    0, HardwareBufferManager::getSingleton().createVertexBuffer(
//		           sizeof(ImDrawVert), vtxBuf.size(),
//		           HardwareBuffer::HBU_WRITE_ONLY));
//	}
//	if(!mRenderOp.indexData->indexBuffer ||
//	   mRenderOp.indexData->indexBuffer->getNumIndexes() != idxBuf.size()) {
//		mRenderOp.indexData->indexBuffer =
//		    HardwareBufferManager::getSingleton().createIndexBuffer(
//		        HardwareIndexBuffer::IT_16BIT, idxBuf.size(),
//		        HardwareBuffer::HBU_WRITE_ONLY);
//	}
//
//	// Copy all vertices
//	bind->getBuffer(0)->writeData(0, vtxBuf.size_in_bytes(), vtxBuf.Data, true);
//	mRenderOp.indexData->indexBuffer->writeData(0, idxBuf.size_in_bytes(),
//	                                            idxBuf.Data, true);
//
//	mRenderOp.vertexData->vertexStart = 0;
