...
%CMAKE% -DOGRE_BUILD_COMPONENT_BITES:BOOL="0" -DOGRE_BUILD_COMPONENT_BULLET:BOOL="0" -DOGRE_BUILD_RENDERSYSTEM_GL:BOOL="0" -DOGRE_INSTALL_DOCS:BOOL="0" -DOGRE_BUILD_PLUGIN_DOT_SCENE="0" -DOGRE_BUILD_SAMPLES:BOOL="0" -DOGRE_INSTALL_SAMPLES:BOOL="0" %SRC%
